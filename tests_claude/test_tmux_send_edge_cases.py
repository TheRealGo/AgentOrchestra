...
class TmuxSendEdgeCaseTests(unittest.TestCase):
    ...
    def test_send_text_accepts_new_prompt_activity_when_long_wrapped_probe_does_not_match(self) -> None:
        message = (
            "MainAgent: You are pro-backend-runtime. Current user goal: read SPEC.claude.md "
        ...
        capture = (
            ...
            "  runtime. Current user goal: read SPEC.claude.md and improve AgentOrchestra\n"
