...
RUNTIME_FILES = (
    ...
    "agent_state_update.py",
    "apply_back_readiness.py",
    "autonomy_policy.py",
    "candidate_ledger.py",
    "cli.py",
    "codex_config.py",
    "codex_features.py",
    "completion_profiles.py",
    "doctor.py",
    "doctor_codex.py",
    "launch_args.py",
    "launch_env.py",
    ...
    "server_health.py",
    "server_process.py",
    "server_process_runtime.py",
    "service_e2e_intake.py",
    "service_e2e_intake_cli.py",
    "self_e2e_active_main.py",
    "self_e2e_finalizer.py",
    "self_e2e_status.py",
    "self_e2e_task_mirror.py",
    "self_e2e_zero_issue.py",
    "self_exit.py",
    "self_exit_cli.py",
    "self_exit_session.py",
    "pane_manifest.py",
    "user_needed.py",
    "task_file.py",
    "tmux_targets.py",
    "tmux_delivery.py",
    "tmux_delivery_markers.py",
    "tmux_liveness.py",
    "tmux_peer_mailbox.py",
    "tmux_probe.py",
    "rekick.py",
    "tmux_send.py",
    "tmux_send_result_json.py",
    "tmux_wake.py",
)
