...
AGENT_ORCHESTRA_OPERATING_IDENTITY = read_agent_template("common.AGENTS.md")


def role_contract(agent_kind: str) -> str:
    if agent_kind == "MainAgent":
        return read_agent_template("main.AGENTS.md")
    return read_agent_template("professional.AGENTS.md")
